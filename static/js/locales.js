...
const translations = {
    'zh-CN': {
        ...
        'cameraCapture': '摄像头/外置视觉',
        'cameraEnabled': '启用摄像头工具（AI可主动调用）',
        'cameraIndex': '摄像头索引',
        'cameraIndexPlaceholder': '0=默认摄像头，1=外置摄像头，依此类推',
        'cameraPrompt': '默认分析指令',
        'cameraPromptPlaceholder': '请输入给视觉模型的默认分析指令',
        'snapshotCamera': '摄像头拍照',
        'cameraSnapshotOk': '已拍照',
        'cameraSnapshotFail': '摄像头拍照失败',
        'qwenVlLocal': '本地 Qwen VL (vLLM)',
        'qwenVlReady': '就绪',
        'qwenVlLoading': '加载中',
        'qwenVlStopped': '未运行',
        'qwenVlStarting': '已启动 Qwen VL（加载中，请稍候）',
        'qwenVlFail': 'Qwen VL 操作失败',
        'qwenVlModelPath': '模型路径',
        'qwenVlHostPort': '监听 Host:Port',
        'qwenVlServedName': '服务名',
        'qwenVlExtraArgs': '额外启动参数',
        'qwenVlCommandTemplate': '自定义命令模板',
        'qwenVlAutoFillCamera': '启动后自动填入摄像头 API',
        'qwenVlLogs': '启动日志',
        'captureSource': '捕获源',
        'captureSourceCamera': '摄像头',
        'captureSourceMonitor': '显示器',
        'captureSourceWindow': '窗口/程序',
        'captureAllScreens': '全部屏幕拼接',
        'captureSelectPlaceholder': '选择捕获源',
        'captureNoSources': '点击"刷新"以枚举',
        'captureWindowPlaceholder': '选择窗口（可按程序名/标题搜索）',
        'captureWindowTitle': '标题关键词',
        'captureSourcesFail': '枚举捕获源失败',
        'refresh': '刷新',
        ...
        'docker': 'Docker',
        'dockerInstructions':'请确保您已经安装了Docker，并且Docker服务正在运行。你可以复制以下代码在终端中运行，以启动一个YUI-MHCP001的本地服务。⭐注意！`./super-agent-data`可以替换为任意本地文件夹，docker启动后，所有数据都将缓存到该本地文件夹，不会上传到任何地方。',
      ...
      'bodyPlaceholder': `请输入请求体，使用JSON Schema格式。例如：
{
    ...
    "required": ["name", "age"]
        ...
        'sherpaLanguage': '识别语言',
        'sherpaLangAuto': '自动识别（中日英韩粤）',
        'sherpaLangZh': '仅中文',
        'sherpaLangJa': '仅日语',
        'sherpaLangZhJa': '中文 + 日语',
        'sherpaLangEn': '仅英语',
        'audioInputDevice': '输入音频设备（麦克风）',
        'audioOutputDevice': '输出音频设备（扬声器）',
        'defaultDevice': '系统默认',
        'refreshDevices': '刷新设备列表',
        'audioDeviceSettings': '音频设备',
        'audioDeviceNotice': '选择用于语音输入和输出的音频设备',
        'vrcOsc': 'VRChat OSC 字幕',
        'vrcOscEnable': '启用 VRChat OSC',
        'vrcOscHost': 'OSC 目标地址',
        'vrcOscPort': 'OSC 目标端口',
        'vrcOscSendUserInput': '发送用户输入到 VRC 字幕',
        'vrcOscSendAIResponse': '发送 AI 回复到 VRC 字幕',
        'vrcOscNotice': '启用后，对话内容将通过 OSC 协议发送到 VRChat Chatbox，实现游戏内字幕显示。VRChat 默认监听端口 9000。',
        'vrcOscConnected': 'VRChat OSC 已连接',
        'vrcOscDisconnected': 'VRChat OSC 已断开',
        'ttsModel': '语音合成模型',
        'asrReady': '语音识别已准备就绪',
        'ttsEngine': '语音合成接口',
        'tts': '语音合成',
        ...
        'gotoPartyExtension': '前往`YUI-MHCP001`浏览器扩展',
        'browserNotice6': '⭐`YUI-MHCP001`浏览器扩展可以将你的本地party嵌入到浏览器中使用',
...
key3`,
        ...
        'guide.driver-guide-btn':'欢迎使用YUI-MHCP001！',
    ...
    'en-US': {
        ...
        'cameraCapture': 'Camera / External Vision',
        'cameraEnabled': 'Enable Camera Tool (AI can call actively)',
        'cameraIndex': 'Camera Index',
        'cameraIndexPlaceholder': '0=default camera, 1=external camera, etc.',
        'cameraPrompt': 'Default Analysis Prompt',
        'cameraPromptPlaceholder': 'Enter the default prompt sent to the vision model',
        'snapshotCamera': 'Camera Snapshot',
        'cameraSnapshotOk': 'Snapshot taken',
        'cameraSnapshotFail': 'Camera snapshot failed',
        'qwenVlLocal': 'Local Qwen VL (vLLM)',
        'qwenVlReady': 'Ready',
        'qwenVlLoading': 'Loading',
        'qwenVlStopped': 'Stopped',
        'qwenVlStarting': 'Qwen VL started (loading, please wait)',
        'qwenVlFail': 'Qwen VL operation failed',
        'qwenVlModelPath': 'Model Path',
        'qwenVlHostPort': 'Listen Host:Port',
        'qwenVlServedName': 'Served Name',
        'qwenVlExtraArgs': 'Extra Launch Args',
        'qwenVlCommandTemplate': 'Custom Command Template',
        'qwenVlAutoFillCamera': 'Auto-fill Camera API after start',
        'qwenVlLogs': 'Launch Logs',
        'captureSource': 'Capture Source',
        'captureSourceCamera': 'Camera',
        'captureSourceMonitor': 'Monitor',
        'captureSourceWindow': 'Window/App',
        'captureAllScreens': 'All screens stitched',
        'captureSelectPlaceholder': 'Select capture source',
        'captureNoSources': 'Click Refresh to enumerate',
        'captureWindowPlaceholder': 'Select window (searchable by exe/title)',
        'captureWindowTitle': 'Title keyword',
        'captureSourcesFail': 'Failed to enumerate sources',
        'refresh': 'Refresh',
      ...
      'bodyPlaceholder': `Enter the body in JSON Schema format. For example:
{
    ...
    "required": ["name", "age"]
        ...
        'sherpaLanguage': 'Recognition Language',
        'sherpaLangAuto': 'Auto Detect (zh/ja/en/ko/yue)',
        'sherpaLangZh': 'Chinese Only',
        'sherpaLangJa': 'Japanese Only',
        'sherpaLangZhJa': 'Chinese + Japanese',
        'sherpaLangEn': 'English Only',
        'audioInputDevice': 'Audio Input Device (Microphone)',
        'audioOutputDevice': 'Audio Output Device (Speaker)',
        'defaultDevice': 'System Default',
        'refreshDevices': 'Refresh Device List',
        'audioDeviceSettings': 'Audio Devices',
        'audioDeviceNotice': 'Select audio devices for voice input and output',
        'vrcOsc': 'VRChat OSC Subtitles',
        'vrcOscEnable': 'Enable VRChat OSC',
        'vrcOscHost': 'OSC Target Host',
        'vrcOscPort': 'OSC Target Port',
        'vrcOscSendUserInput': 'Send user input to VRC chatbox',
        'vrcOscSendAIResponse': 'Send AI response to VRC chatbox',
        'vrcOscNotice': 'When enabled, conversation content will be sent to VRChat Chatbox via OSC protocol for in-game subtitle display. VRChat listens on port 9000 by default.',
        'vrcOscConnected': 'VRChat OSC Connected',
        'vrcOscDisconnected': 'VRChat OSC Disconnected',
        'ttsModel': 'TTS Model',
        'asrReady': 'ASR Ready',
        ...
        'gotoPartyExtension': 'Go to the `YUI-MHCP001` browser extension',
        'browserNotice6': '⭐The `YUI-MHCP001` browser extension allows you to embed your local party into the browser for use.',
...
Key3`,
        ...
        'guide.driver-guide-btn':'Welcome to YUI-MHCP001!',
