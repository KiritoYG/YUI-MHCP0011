...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  // VRChat OSC Chatbox
  vrcOscChatbox: ({ host, port, message }) => ipcRenderer.invoke('vrc-osc-chatbox', { host, port, message }),
  vrcOscTyping: ({ host, port, typing }) => ipcRenderer.invoke('vrc-osc-typing', { host, port, typing }),
