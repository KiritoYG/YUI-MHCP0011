...
let vue_data = {
  ...
  "mcpServers": {
    ...
    dockerExamples: `docker pull super-agent-party:latest
docker run -d \\
  -p 3456:3456 \\
  -v ./super-agent-data:/app/data \\
  super-agent-party:latest
`,
    dockerExamples2: `git clone https://github.com/super-agent-party/super-agent-party.git
