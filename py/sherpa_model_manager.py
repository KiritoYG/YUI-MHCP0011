...
MODELS = {
    "modelscope": {
        # 注意：使用标准版 SenseVoice 模型（FunAudioLLM 原版），而非粤语优化版（ASLP-lab/WSYue-ASR）
        # 粤语优化版的日语识别能力严重退化，只能输出汉字无法输出假名
    ...
    "huggingface": {
        # 使用 2024-07-17 标准版模型（支持 zh/en/ja/ko/yue 多语言，日语输出正常含假名）
        # 不要使用 int8-2025-09-09 版本（粤语优化版，日语识别退化）
        ...
        "tokens_url": "https://huggingface.co/csukuangfj/sherpa-onnx-sense-voice-zh-en-ja-ko-yue-2024-07-17/resolve/main/tokens.txt?download=true",
        "files_to_download": [
            {"filename": "model.int8.onnx", "url_key": "url", "progress_key": "model"},
            {"filename": "tokens.txt", "url_key": "tokens_url", "progress_key": "tokens"},
        ]
